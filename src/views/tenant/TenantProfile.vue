          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input 
                  type="text" 
                  v-model.trim="profile.identityCard" 
                  id="identityCard" 
                  class="form-control"
                  :class="{ 'is-invalid': errors.identityCard }"
                  :readonly="!isEditing" 
                />
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input 
                  type="text" 
                  v-model.trim="profile.licensePlate" 
                  id="licensePlate" 
                  class="form-control"
                  :readonly="!isEditing" 
                />
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input 
                  type="date" 
                  v-model="profile.contractEndDate" 
                  id="contractEndDate" 
                  class="form-control" 
                  readonly 
                />
  ...
  methods: {
    async loadProfile() {
      ...
      if (storedProfile) {
        ...
        this.originalProfile = { ...storedProfile };
      }
    },
    ...
    validateForm() {
      ...
      if (!this.profile.identityCard.trim()) {
    ...
    async saveProfile() {
      ...
      try {
        this.isSaving = true;
        localStorage.setItem('currentUserProfile', JSON.stringify(this.profile));
        this.originalProfile = { ...this.profile };
