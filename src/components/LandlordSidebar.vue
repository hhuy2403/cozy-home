    ...
    return {
      ...
      menuItems: [
        ...
        { label: 'Tính tiền', route: '/landlord/calculator-money', icon: 'fas fa-money-check-alt' },
        {
          ...
          open: false,
          children: [
            { label: 'Báo cáo doanh thu', route: '/landlord/report/revenue', icon: 'fas fa-dollar-sign' },
            { label: 'Báo cáo công nợ', route: '/landlord/report/debt', icon: 'fas fa-file-invoice' },
            { label: 'Báo cáo khách thuê', route: '/landlord/report/tenants', icon: 'fas fa-users' },
          ],
        },
